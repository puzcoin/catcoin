...
#ifndef CAT_PRIMITIVES_TRANSACTCAT_H
#define CAT_PRIMITIVES_TRANSACTCAT_H
 ...
 */
 ...
 public:
     ...
     {
         // catcoin: the coin stake transaction is marked with the first output empty
...
#endif // CAT_PRIMITIVES_TRANSACTCAT_H
