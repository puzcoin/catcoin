...
#ifndef CAT_PRIMITIVES_BLOCK_H
#define CAT_PRIMITIVES_BLOCK_H
...
public:
    ...
    // catcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // catcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // catcoin: get max transaction timestamp
