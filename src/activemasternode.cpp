...
// Copyright (c) 2017 Empinel / The CAT Developers
...
//
// Bootup the masternode, look for a 5000 CAT input and register on the network
//
void CActiveMasternode::ManageStatus()
{
    ...
    if(status == MASTERNODE_NOT_PROCESSED) {
        ...
        if(GetMasterNodeVin(vin, pubKeyCollateralAddress, keyCollateralAddress)) {
            ...
            /* donations are not supported in catcoin.conf */
...
{
    CCatcoinAddress address(collateralAddress);
