...
bool DecodeHexTx(CMutableTransaction& tx, const std::string& strHexTx, bool fTryNoWitness)
{
    ...
    if (fTryNoWitness) {
// SERIALIZE_TRANSACTCAT_NO_WITNESS is to be defined in transaction.h
//        CDataStream ssData(txData, SER_NETWORK, PROTOCOL_VERSION | SERIALIZE_TRANSACTCAT_NO_WITNESS);
