                        ...
                        bool* pfMissingInputs, bool fRejectInsaneFee, bool ignoreFees)
{
    ...
    // catcoin: coinstake is also only valid in a block, not as a loose transaction
    if (tx.IsCoinStake())
...
// catcoin: find block wanted by given orphan block
...
// catcoin: find last block index up to pindex
...
bool ProcessBlock(CNode* pfrom, CBlock* pblock)
{
    ...
    if (!mapBlockIndex.count(pblock->hashPrevBlock))
    {
        ...
        if (pfrom) {
            ...
            // catcoin: getblocks may not obtain the ancestor block rejected
