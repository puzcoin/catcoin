...
Value checkkernel(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "Catcoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "Catcoin is downloading blocks...");
...
Value submitblock(const Array& params, bool fHelp)
{
    ...
    try {
        ...
        throw JSONRPCError(RPC_DESERIALIZATCAT_ERROR, "Block decode failed");
    }
