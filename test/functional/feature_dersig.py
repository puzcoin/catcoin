...
class BIP66Test(CatcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # catcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and catcoind produces more specific reject
            # reasons.
