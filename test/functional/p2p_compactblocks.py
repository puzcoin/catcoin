...
# TestNode: A peer we use to send messages to catcoind, and store responses.
...
class CompactBlocksTest(CatcoinTestFramework):
    ...
    # This test actually causes catcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that catcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for catcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # catcoind will not send blocktxn responses for blocks whose height is
