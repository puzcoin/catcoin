...
* catcoin.conf: contains configuration settings for catcoind or catcoin-qt
* catcoind.pid: stores the process id of catcoind while running
...
* debug.log: contains debug information and general logging generated by catcoind or catcoin-qt
