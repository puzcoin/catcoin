...
This document provides guidelines for internationalization of the Catcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `catcoin_en.ts` remains unchanged.
